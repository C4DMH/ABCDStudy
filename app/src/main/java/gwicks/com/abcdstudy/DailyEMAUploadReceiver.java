...
public class DailyEMAUploadReceiver extends BroadcastReceiver {

    private static final String TAG = "DailyEMAUploadReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "onReceive: we have received the broadcast recveiver for Daily EMA Upload");
